...
import {BiBarcode,BiBookBookmark,BiChip,BiFoodMenu,BiGrid,BiDetail,BiSlideshow} from"react-icons/bi"
    ...
    return(
        <div className='wrap'>
         ...
         <div className='container-row'>
            <img src='https://devplus.asia/assets/images/Artboard_2.png' alt='logo'/>
            <h2>ADMIN</h2>
         </div>
         <div className='title-row'>
          ...
          <ul className={checked=== 1 ? `sidebar-title active`:`sidebar-title`}>
